...
public class MarkerDetection extends PApplet {
	...
	public void setup() {
	 ...
	 // opencv = new OpenCV(this, "/Users/chro/Desktop/glassbead/opencv-processing/examples/MarkerDetection/marker_test.jpg");
	 video.start();
	
	}
public void other_setup(){
	  src = opencv.getInput();
	...
	public void draw() {
	  ...
	  float cellSize = (float) (dst.width/7.0);
	  for (int col = 0; col < 7; col++) {
	    for (int row = 0; row < 7; row++) {
	      if(markerCells[row][col]){
	        fill(255);
